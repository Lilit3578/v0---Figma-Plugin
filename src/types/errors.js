...
exports.createExportError = exports.createExecutionError = exports.createResolutionError = exports.createDiscoveryError = exports.createAIError = exports.createValidationError = exports.CompilerError = exports.ERROR_GUIDANCE = exports.ErrorCode = exports.ErrorCategory = void 0;
exports.formatError = formatError;
exports.formatErrorForLog = formatErrorForLog;
exports.createRenderErrorUI = createRenderErrorUI;
var ErrorCategory;
(function (ErrorCategory) {
    ErrorCategory["RSNT_VALIDATION"] = "RSNT_VALIDATION";
    ErrorCategory["AI_ORCHESTRATION"] = "AI_ORCHESTRATION";
    ErrorCategory["DISCOVERY"] = "DISCOVERY";
    ErrorCategory["RESOLUTION"] = "RESOLUTION";
    ErrorCategory["EXECUTION"] = "EXECUTION";
    ErrorCategory["CODE_EXPORT"] = "CODE_EXPORT";
})(ErrorCategory || (exports.ErrorCategory = ErrorCategory = {}));
var ErrorCode;
(function (ErrorCode) {
    // 1000-1999: RSNT Validation Errors
    ErrorCode[ErrorCode["INVALID_SEMANTIC_ROLE"] = 1001] = "INVALID_SEMANTIC_ROLE";
    ErrorCode[ErrorCode["INVALID_LAYOUT_PRIMITIVE"] = 1002] = "INVALID_LAYOUT_PRIMITIVE";
    ErrorCode[ErrorCode["MISSING_REQUIRED_PROPERTY"] = 1003] = "MISSING_REQUIRED_PROPERTY";
    ErrorCode[ErrorCode["CIRCULAR_DEPENDENCY"] = 1004] = "CIRCULAR_DEPENDENCY";
    ErrorCode[ErrorCode["EXCEEDS_MAX_DEPTH"] = 1005] = "EXCEEDS_MAX_DEPTH";
    // 2000-2999: AI Orchestration Errors
    ErrorCode[ErrorCode["API_REQUEST_FAILED"] = 2001] = "API_REQUEST_FAILED";
    ErrorCode[ErrorCode["INVALID_JSON_RESPONSE"] = 2002] = "INVALID_JSON_RESPONSE";
    ErrorCode[ErrorCode["SCHEMA_VALIDATION_FAILED"] = 2003] = "SCHEMA_VALIDATION_FAILED";
    ErrorCode[ErrorCode["CONFIDENCE_TOO_LOW"] = 2004] = "CONFIDENCE_TOO_LOW";
    ErrorCode[ErrorCode["TIMEOUT"] = 2005] = "TIMEOUT";
    // 3000-3999: Discovery Errors
    ErrorCode[ErrorCode["NO_COMPONENTS_FOUND"] = 3001] = "NO_COMPONENTS_FOUND";
    ErrorCode[ErrorCode["NO_VARIABLES_FOUND"] = 3002] = "NO_VARIABLES_FOUND";
    ErrorCode[ErrorCode["FINGERPRINTING_FAILED"] = 3003] = "FINGERPRINTING_FAILED";
    ErrorCode[ErrorCode["CACHE_CORRUPTED"] = 3004] = "CACHE_CORRUPTED";
    // 4000-4999: Resolution Errors
    ErrorCode[ErrorCode["NO_RESOLUTION_FOUND"] = 4001] = "NO_RESOLUTION_FOUND";
    ErrorCode[ErrorCode["COMPONENT_NOT_FOUND"] = 4002] = "COMPONENT_NOT_FOUND";
    ErrorCode[ErrorCode["VARIABLE_NOT_FOUND"] = 4003] = "VARIABLE_NOT_FOUND";
    ErrorCode[ErrorCode["MAPPING_FAILED"] = 4004] = "MAPPING_FAILED";
    // 5000-5999: Execution Errors
    ErrorCode[ErrorCode["NODE_CREATION_FAILED"] = 5001] = "NODE_CREATION_FAILED";
    ErrorCode[ErrorCode["LAYOUT_APPLICATION_FAILED"] = 5002] = "LAYOUT_APPLICATION_FAILED";
    ErrorCode[ErrorCode["PROPERTY_BINDING_FAILED"] = 5003] = "PROPERTY_BINDING_FAILED";
    ErrorCode[ErrorCode["GENERATION_CANCELLED"] = 5004] = "GENERATION_CANCELLED";
    // 6000-6999: Code Export Errors
    ErrorCode[ErrorCode["NO_RSNT_METADATA_FOUND"] = 6001] = "NO_RSNT_METADATA_FOUND";
    ErrorCode[ErrorCode["EXPORT_FORMAT_INVALID"] = 6002] = "EXPORT_FORMAT_INVALID";
    ErrorCode[ErrorCode["CODE_GENERATION_FAILED"] = 6003] = "CODE_GENERATION_FAILED";
    ErrorCode[ErrorCode["EXPORT_VALIDATION_FAILED"] = 6004] = "EXPORT_VALIDATION_FAILED";
})(ErrorCode || (exports.ErrorCode = ErrorCode = {}));
exports.ERROR_GUIDANCE = {
...
class CompilerError extends Error {
    constructor(code, category, details, customMessage) {
        const errorInfo = exports.ERROR_GUIDANCE[code];
...
// Factory functions
const createValidationError = (code, details, message) => new CompilerError(code, ErrorCategory.RSNT_VALIDATION, details, message);
exports.createValidationError = createValidationError;
const createAIError = (code, details, message) => new CompilerError(code, ErrorCategory.AI_ORCHESTRATION, details, message);
exports.createAIError = createAIError;
const createDiscoveryError = (code, details, message) => new CompilerError(code, ErrorCategory.DISCOVERY, details, message);
exports.createDiscoveryError = createDiscoveryError;
const createResolutionError = (code, details, message) => new CompilerError(code, ErrorCategory.RESOLUTION, details, message);
exports.createResolutionError = createResolutionError;
const createExecutionError = (code, details, message) => new CompilerError(code, ErrorCategory.EXECUTION, details, message);
exports.createExecutionError = createExecutionError;
const createExportError = (code, details, message) => new CompilerError(code, ErrorCategory.CODE_EXPORT, details, message);
...
function formatError(error, context) {
    if (error instanceof CompilerError) {
        return {
            ...
            title: exports.ERROR_GUIDANCE[error.code].message,
    ...
    if (code !== 0) {
        const info = exports.ERROR_GUIDANCE[code];
        return {
            code,
            category,
            title: info.message,
 ...
 */
function createRenderErrorUI(error, nodeId, severity = 'error', recoveryAction) {
    return {
        severity,
        message: error.message,
        nodeId,
